...
interface CheckboxListNuqsProps {
  paramName?: string
  options?: CheckboxOption[]
}

const CheckboxListNuqs = ({ 
  paramName = 'tipo', 
  options = defaultOptions 
}: CheckboxListNuqsProps) => {
  ...
  return (
    <RenderFlash>
      <div className="space-y-3">
        <h3 className="text-lg font-semibold">Checkbox List (nuqs)</h3>
...
export default CheckboxListNuqs
